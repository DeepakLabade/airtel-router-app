...
export const printStage04label = async (req, res) => {
  try {
    const { modelNo, macAddress, gponNo } = req.body;
    ...
    const labelPath =
      ...
      "C:\\Users\\DEEPAK\\Downloads\\Bartender Feb 2026\\Wifi 5\\Wifi 5 Gift box.btw";
